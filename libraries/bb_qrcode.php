...
{
	var $cacheable = true;
	var $cachedir = 'static/app/';
	var $errorlog = 'static/app/';
	var $quality = true;
	var $size = 1024;
	...
	public function initialize($config = array()) {
		...
		include "lib/qrcode/qrconst.php";
		include "lib/qrcode/qrtools.php";
		include "lib/qrcode/qrspec.php";
		include "lib/qrcode/qrimage.php";
		include "lib/qrcode/qrinput.php";
		include "lib/qrcode/qrbitstream.php";
		include "lib/qrcode/qrsplit.php";
		include "lib/qrcode/qrrscode.php";
		include "lib/qrcode/qrmask.php";
		include "lib/qrcode/qrencode.php";
	}
